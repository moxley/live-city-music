...
LOCK_FILE="$SHARED_DIR/tmp/${APP}-lock"
PID_FILE="$SHARED_DIR/tmp/pids/sidekiq.pid"
GEMFILE="$APP_DIR/Gemfile"
SIDEKIQ="sidekiq"
RAILS_ENV="production"
BUNDLE="bundle"

START_CMD="$BUNDLE exec $SIDEKIQ -e $RAILS_ENV -C ${APP_CONFIG}/sidekiq.yml -P $PID_FILE"
